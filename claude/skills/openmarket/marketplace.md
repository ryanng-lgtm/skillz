...
## Routine packs
Schedules plus carried watches as one pack: publish `schedule:<id>` to the registry like any kind, members install paused, each kind has its own arm ritual.
