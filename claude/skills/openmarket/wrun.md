...
Build: §"The authoring loop" · sheet: §"Metadata dialect" · source declarations: §"Source-declared indicators (code-first)" · reference markets: §"Input pins" · per-use markets: §"Bindable odds inputs" · plot styles: §"Chart placement and styling" · frames, profiles, panels, HUDs and watch series: §"Snapshots, panels and pane placement". Install: `marketplace.md §"Rules"` · mount, bind, repoint, list, remove: `marketplace.md §"Indicator packages"`.
